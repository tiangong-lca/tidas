...
description: "How to obtain and verify the single cross-platform tidas binary from Latest Release, what each of the seven unified subcommands does, how --schema-only differs from a full validate, and how the retired command entry points map onto the unified CLI."
---
...
- 📚 Source and complete CLI documentation: [tidas-toolkit repository](https://github.com/tiangong-lca/tidas-toolkit)

- 📌 Questions and feature requests: [Create an Issue](https://github.com/tiangong-lca/tidas-toolkit/issues)

- 📦 Authoritative release history: [GitHub Releases](https://github.com/tiangong-lca/tidas-toolkit/releases)
