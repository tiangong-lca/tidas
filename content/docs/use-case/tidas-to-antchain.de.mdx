...
1. Systemanmeldung und Token-Autorisierung
   Token: `example-access-token` (redigierter Platzhalter)
...
2. Ursprünglichen Zertifizierungshash über den Transaktionshash abfragen
   ...
   Server-Prüftoken: `example-verification-token`
...
Die Hashwerte stimmen überein; die Datenintegrität ist bestätigt.
```
