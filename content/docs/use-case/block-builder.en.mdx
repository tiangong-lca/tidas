---
title: "HiQ-Editor and TIDAS Integration Case Study"
...
![Editing data in HiQ-Editor](/img/use-case/block-builder-edit.png)
...
![Importing an ILCD document into TIDAS](/img/use-case/block-builder-import.png)
