...
### 🧾 Data Format
- [TIDAS Data Structure](/fr/docs/category/tidas-schema/)  
...
👉 See full tool documentation: [TIDAS Toolkit](/fr/docs/category/tidas-tools/)
...
> 2. [Data Structure Format](/fr/docs/category/tidas-schema/)  
> 3. [Reference Data Package](https://github.com/linancn/EF-reference-package-3.1-Correction)  
> 4. [Tool Module](/fr/docs/category/tidas-tools/) and [Integration Solutions](/fr/docs/category/integration/)
