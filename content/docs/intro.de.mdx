...
- [TIDAS Data Structure](/de/docs/category/tidas-schema/)  
...
👉 See full tool documentation: [TIDAS Toolkit](/de/docs/category/tidas-tools/)
...
> 2. [Data Structure Format](/de/docs/category/tidas-schema/)  
> 3. [Reference Data Package](https://github.com/linancn/EF-reference-package-3.1-Correction)  
> 4. [Tool Module](/de/docs/category/tidas-tools/) and [Integration Solutions](/de/docs/category/integration/)
