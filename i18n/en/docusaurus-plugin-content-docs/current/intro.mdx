...
**The TIDAS Toolkit consists of auxiliary components developed around the three core modules**, facilitating data construction, format interoperability and export operations between developers and systems.
...
👉 See full tool documentation: [TIDAS Toolkit](/docs/category/tidas-tool)
...
- 🛡 [Data Space Integration](./integration/tidas-to-data-space.md): Supports secure data sharing and privacy protection  
- 🔗 [Blockchain Integration](./integration/tidas-to-blockchain.md): Enables data immutability and distributed verification  
- 🤖 [AI Integration (MCP Service)](./integration/tidas-to-ai.md): Integrates MCP AI Server for data semantic analysis, completion and intelligent validation
...
- 📘 [Documentation Contribution Guide](/docs/how-to-contribute-tidas-doc.md)  
- 🐞 [Bug Reports](https://github.com/tiangong-lca/tidas/issues)  
- 💼 For commercial support contact: **contact@tiangong.earth**
...
> 4. [Tool Module](/docs/category/tidas-tool) and [Integration Solutions](/docs/category/integration)
